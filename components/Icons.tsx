...
export const RobotIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M12 6V5m0 14v-1m-4-13h8a2 2 0 012 2v10a2 2 0 01-2 2h-8a2 2 0 01-2-2V7a2 2 0 012-2z" />
  </svg>
);
...
export const HandshakeIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c1.104 0 2-.896 2-2s-.896-2-2-2-2 .896-2 2 .896 2 2 2zm0 2c-1.104 0-2 .896-2 2s.896 2 2 2 2-.896 2-2-.896-2-2-2zm-5 4c0 1.104.896 2 2 2h6c1.104 0 2-.896 2-2 0-1.104-.896-2-2-2H9c-1.104 0-2 .896-2 2zm11-4.707a2.984 2.984 0 00-4.243 0L12 11.05l-1.757-1.757a2.984 2.984 0 00-4.243 0 2.984 2.984 0 000 4.243L12 17.586l6.243-6.243a2.984 2.984 0 000-4.243z" />
  </svg>
);
...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 010 1.414L15 12l-1.293-1.293a1 1 0 010-1.414L16 7m-4 10l2.293 2.293a1 1 0 010 1.414L12 21l-1.293-1.293a1 1 0 010-1.414L13 17m-4-4l-2.293-2.293a1 1 0 010-1.414L9 8l1.293 1.293a1 1 0 010 1.414L8 13z" />
  </svg>
);

export const LightbulbIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707m12.728 0l-.707-.707M12 21V11a5 5 0 00-5-5H7a5 5 0 00-5 5v2a1 1 0 001 1h14a1 1 0 001-1v-2a5 5 0 00-5-5h-1a5 5 0 00-5 5z" />
  </svg>
);
...
export const TargetIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none">
    ...
    <circle cx="12" cy="12" r="10" stroke="url(#targetGradient)" strokeWidth="1.5" />
    <circle cx="12" cy="12" r="6" stroke="url(#targetGradient)" strokeWidth="1.5" />
    <circle cx="12" cy="12" r="2" fill="url(#targetGradient)" />
  </svg>
);

export const RedXIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const ChatBubbleIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.722.345c-.234.022-.462.05-.688.082a4.502 4.502 0 01-1.82.262c-1.352 0-2.662-.51-3.616-1.414a4.502 4.502 0 01-1.414-3.616c.032-.226.06-.454.082-.688l.345-3.722c.093-1.133.957-1.98 2.193-1.98h4.286c.969 0 1.813.616 2.097 1.5z" />
  </svg>
);

export const SadEmojiIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9 9 0 100-18 9 9 0 000 18z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.5 14.5c-.33-.33-.76-.5-1.2-.5h-4.6c-.44 0-.87.17-1.2.5M9 9h.01M15 9h.01" />
    </svg>
);
